...
See [Configuration](/docs/configuration/) for the full list of environment variables and config fields.
...
![trinops query list](/screenshots/query-list.svg)
...
- [TUI Dashboard](/docs/tui/) — keybindings, layout, and kill workflow
- [Schema Search](/docs/schema/) — explore catalogs and tables from the terminal
- [CLI Reference](/docs/cli/) — every command and flag
- [Configuration](/docs/configuration/) — profiles, auth methods, and tuning
